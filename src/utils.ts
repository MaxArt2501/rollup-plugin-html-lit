import { createSourceFile, ExpressionStatement, ScriptTarget, TemplateExpression } from 'typescript';
...
const getExpressionPositions = (html: string): Interval[] => {
  ...
  return tpl.templateSpans.flatMap(span => getAllChunks(span.expression));
};
